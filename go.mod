...
// github.com/vr4manta/library-go@vsphere_multi_disk
replace github.com/openshift/library-go => github.com/vr4manta/library-go v0.0.0-20241025191808-a916640b6420
