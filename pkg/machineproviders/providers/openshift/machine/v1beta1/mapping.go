...
func mapMachineIndexesToFailureDomains(logger logr.Logger, machines []machinev1beta1.Machine, replicas int32, failureDomains []failuredomain.FailureDomain, templateFailureDomain failuredomain.FailureDomain, infrastructure *configv1.Infrastructure) (map[int32]failuredomain.FailureDomain, error) {
